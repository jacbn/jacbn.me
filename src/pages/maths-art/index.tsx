  ...
  return (
    <div className="projectHomeContainer">
      ...
      <ol className="mathsArtGrid">
        <MathsSquare href="./apollo" title="Apollonian Gaskets" image={{src: require("/src/assets/maths/apollo.png"), srcLight: require("/src/assets/maths/apollo-light.png"),  alt: "An image of an Apollonian Gasket."}} />
        <MathsSquare href="./radials" title="Radial Circles" image={{src: require("/src/assets/maths/radials.png"), srcLight: require("/src/assets/maths/radials-light.png"), alt: "An image of a nested epicycloid."}} />
        <MathsSquare href="./lotfollah" title="Lotfollah Mosque Dome" image={{src: require("/src/assets/maths/lotfollah.png"), srcLight: require("/src/assets/maths/lotfollah-light.png"), alt: "An image of a reconstruction of the Lotfollah Mosque Dome."}} />
      </ol>
    </div>
  );
}
