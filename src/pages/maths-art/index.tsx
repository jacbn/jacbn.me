  ...
  return (
    <div className="projectHomeContainer">
      ...
      <ol className="mathsArtGrid">
        <MathsSquare href="./apollo" title="Apollonian Gaskets" image={{src: "/src/assets/maths/apollo.png", srcLight: "/src/assets/maths/apollo-light.png",  alt: "An image of an Apollonian Gasket."}} />
        <MathsSquare href="./radials" title="Radial Circles" image={{src: "/src/assets/maths/radials.png", srcLight: "/src/assets/maths/radials-light.png", alt: "An image of a nested epicycloid."}} />
        <MathsSquare href="./lotfollah" title="Lotfollah Mosque Dome" image={{src: "/src/assets/maths/lotfollah.png", srcLight: "/src/assets/maths/lotfollah-light.png", alt: "An image of a reconstruction of the Lotfollah Mosque Dome."}} />
      </ol>
    </div>
  );
}
