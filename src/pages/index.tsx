  ...
  return <HomeText
    ...
    text={
      <>
        ...
        <p className="inset">I love cycling, listening to music, watching movies, gaming and travel. It's a bit of a dream of mine to tour Scandinavia one day, especially the northernmost parts to see the Northern Lights at their greatest. I've been learning Swedish for almost two years now, in the hope of not being completely lost — det är ett vackart språk! </p>
