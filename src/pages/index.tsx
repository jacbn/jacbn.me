  ...
  return <HomeText
    ...
    text={
      <>
        ...
        <p className="inset">
          I currently work as an EdTech Software Engineer for the <a href="https://isaacphysics.org">Isaac Platform</a> (including <a href="https://adacomputerscience.org">Ada CS</a> and others to come), and I love it! I work mainly on the frontend of the platform, building the site and the tools that teachers and students use on a daily basis. It's very fulfilling — I get to see the impact of my work on a daily basis, and I'm working with a great team of people who are all passionate about what they do.
          Last year, my work on yawning detection paid off — my dissertation won the CST Department Prize for a Highly Commended Dissertation, and the related published paper is available <a href="https://dl.acm.org/doi/10.1145/3615592.3616854">here</a>!
        </p>
        ...
        <p className="inset">I love cycling, listening to music, watching movies, gaming, languages and travel. I recently fulfilled a huge dream of mine to tour Scandinavia, starting in Sweden and doing a loop around there, Norway and Denmark. It was such an incredible experience — the Swedish I've been learning paid off, and I have memories to last a lifetime. I'd love to go back and see the northernmost parts at some point to see the Northern Lights at their greatest!</p>
