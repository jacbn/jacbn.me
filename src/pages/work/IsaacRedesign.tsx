...
export const IsaacRedesign = (props: React.HTMLAttributes<HTMLElement>) => {
    ...
    return <UnstyledPageContainer {...props} className={classNames("isaac-redesign bg-white")}>
        ...
        <section id="hero" className="d-flex flex-column align-items-center">
            ...
            {below["md"](deviceSize)
                ? <img id="hero-text-sm" className="my-6 w-90 w-sm-70 position-relative object-fit-contain" src="/assets/isaac-redesign/title-text-xs.svg" />
                : <img id="hero-text" height="400px" className="w-100 position-relative object-fit-contain" src="/assets/isaac-redesign/title-text.svg" />
            }
            {below["sm"](deviceSize)
                ? <img id="phone-decor-md" height="410px" className="w-100 position-absolute" src="/assets/isaac-redesign/phone-decor-md.svg" alt="" />
                : below["md"](deviceSize)
                    ? <img id="phone-decor-md" height="720px" className="position-absolute" src="/assets/isaac-redesign/phone-decor-md.svg" alt="" />
                    : <img id="phone-decor" className="position-absolute" src="/assets/isaac-redesign/phone-decor-lg.svg" alt="" />
            }
            {below["sm"](deviceSize)
                ? <img id="phone-sm" height="400px" className="w-100 position-relative object-fit-contain" src="/assets/isaac-redesign/isaac-phone.png" alt="A preview of the redesigned Isaac Science platform, showcasing a modern and clean interface." />
        ...
        <section id="need-for-change" className="py-8 py-md-12">
        ...
        <section id="nav-overview" className="my-8 my-md-12">
            <FadeInWhenVisible className="container-lg text-black">
                <div className="bento-card p-4">
                    <img className="w-100 h-100" src="/assets/isaac-redesign/nav-menu.png" />
                </div>
                <h4>Multidisciplinary overhaul</h4>
                <p className="small">Navigation on the new site, with shortcuts to all subject-stage pairs on the homepage and from the navbar.</p>
            </FadeInWhenVisible>
        </section>
        <section id="fluent-overview">
            ...
            <FadeInWhenVisible className="container-lg position-relative text-black py-8 py-md-12">
            ...
            <div className="d-flex flex-column gap-3 container-lg py-9 text-black bg-white">
                <FadeInWhenVisible className="row g-5">
                    <div className="d-flex flex-column col-lg-4">
                        ...
                        <h4>Solving the scrollbar on mobile</h4>
                        <p className="small">Our "sidebar-first" approach worked great on desktop, but did not translate well to mobile. I developed a dynamic, always-accessible sidebar button that collapses when scrolled past.</p>
                    </div>
                    <div className="d-flex flex-column col-lg-8">
                        ...
                        <p className="small">I componentised and extended the provided Figma project. As a sample, the above shows my reworking of card components, built in two scales for Events (small) and Programmes (large).</p>
                    </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible className="row g-5">
                    <div className="d-flex flex-column col-lg-7">
                        ...
                        <h4>Spotlight: Book pages</h4>
                        <p className="small">The site's book content underwent a complete overhaul, turning hard-coded pages into a beautified system of chapters entirely modifiable from our in-house content editor.</p>
                    </div>
                    <div className="col-lg-5">
                        <div id="inline-questions" className="bento-card">
                            <img className="w-100 h-100" src="/assets/isaac-redesign/inline.png" />
                        </div>
                        <h4>Spotlight: Inline questions</h4>
                        <p className="small">Alongside the redesign, a new inline question type allows authors to create interactive questions embedded directly within content.</p>
                    </div>
                </FadeInWhenVisible>
                <FadeInWhenVisible className="row g-5">
                    <div className="d-flex flex-column col-lg-4">
                        ...
                        <h4>Rebuilding the markbook</h4>
                        <p className="small">With conflicting and ever-changing requirements, designing the markbook was a complex challenge that required careful planning and iteration.</p>
                    </div>
                    <div className="col-lg-8">
                        <div id="accessibility" className="bento-card">
                            <img className="w-100 h-100" src="/assets/isaac-redesign/accessibility.png" />
                        </div>
                        <h4>Site-wide accessibility</h4>
                        <p className="small">A major personal focus was to improve accessibility throughout the site, both through design and implementation. Features are laid out with priority for common use cases, and aria labels, skipnavs and landmark roles are properly used to assist screen reader navigation.</p>
                    </div>
                </FadeInWhenVisible>
            </div>
        </section>
        <section id="outro" className="mt-4">
            <FadeInWhenVisible id="outro-main" className="container-lg pt-8 position-relative">
        ...
        <img className="w-100" src="/assets/isaac-redesign/spill-bg.svg" />
