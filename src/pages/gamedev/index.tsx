      ...
      <>
        ...
        <main className={bodyStyles.projectHomeContainer}>
          ...
          <VerticalPane
            ...
            description={
              <>
                <p><b>AmalgMG</b> is a MonoGame-based .NET engine with support for physics, shaders, tilemaps, animation and more, built out of frustration at Unity's 2D engine. The aim of the library is to mimic the coding style supported by Unity, while enabling intimate control over all parts of the engine to simplify support for writing custom components. It's still in its infancy, but the current end goal would be an engine able to produce jam-style games.</p>
              </>
            }
            />
            <VerticalPane
