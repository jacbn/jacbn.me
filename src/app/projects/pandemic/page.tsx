      ...
      <Blog 
        ...
        text={
            <>
                ...
                <img className={styles.pandemicIm} src="/assets/pandemic/Figure_2.png"/>
                ...
                <img className={styles.pandemicIm} src="/assets/pandemic/Figure_4.png"/>
                <h3>Figure 3: Phase-space plot of R-value against number of people infected (4 countries)</h3>
                <img className={styles.pandemicIm} src="/assets/pandemic/Figure_5.png"/>
            </>
        }
        />
    </>
