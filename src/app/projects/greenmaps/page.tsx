      ...
      <Blog 
        ...
        text={
          <>
            ...
            <p>In the app, a user can plot their journey by entering a start and end location, for which a number of different routes are calculated. The carbon emissions of each route is then calculated as accurately as possible &#8212; for example in a car, the app would take into account the make of car used, the average speed along each road used, the type of fuel used and more. To make this process streamlined, each user can enter their car's information once when they first download the app then reuse that profile, or indeed enter multiple car profiles over time and switch between them as necessary.</p>
